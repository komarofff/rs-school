...
language ? homeTitle = 'Welcome to game!' : homeTitle = 'Добро пожаловать в игру!'
language ? homeSubtitle = '<h2>Immerse yourself in the world of a variety of bird voices!</h2>\n  <h2>Take an exciting quiz and find out how many bird songs you can guess!</h2>' : homeSubtitle = '<h2>Окунитесь в мир разнообразия птичьих голосов!</h2>\n          <h2>Пройди увлекательную викторину и узнай сколько птичьих песен ты сможешь угадать!</h2>'
language ? homeInviting = 'For starting game press button <strong class="start-game-button">"Start game"</strong>' : homeInviting = 'Для старта игры нажми кнопку <strong class="start-game-button">"Начать игру"</strong>'
